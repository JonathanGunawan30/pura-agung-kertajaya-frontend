...
export async function generateMetadata(): Promise<Metadata> {
    ...
    return {
        title: {
            default: siteIdentity?.site_name || 'Yayasan Vidya Kertajaya',
            template: `%s | ${siteIdentity?.site_name || 'Yayasan Vidya Kertajaya'}`
        },
        description: siteIdentity?.description || 'Melayani umat melalui pendidikan dan sosial.',
        icons: {
